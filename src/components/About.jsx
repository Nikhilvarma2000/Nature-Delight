...
const About = () => {
  return (
    <div id="about" className="min-h-screen bg-gradient-to-r from-orange-400 to-yellow-500 p-8 flex flex-col justify-center items-center">
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-4xl w-full mt-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-6">
          <div className="bg-orange-100 p-4 rounded-lg shadow-md text-center transform transition-all duration-300 hover:scale-105">
