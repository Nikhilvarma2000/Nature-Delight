...
const HomePageButton = () => {
  ...
  return (
    <div>
      {/* Form Section */}
      <div className="w-full min-h-screen bg-yellow-100 flex items-center justify-center py-10">
      ...
      <div className="flex justify-center py-8">
        <a
          href="tel:+1234567890"
          className="bg-green-500 text-white py-3 px-6 rounded-full text-lg font-semibold shadow-md hover:bg-green-600 transition duration-300"
        >
          Call Now
        </a>
      </div>
